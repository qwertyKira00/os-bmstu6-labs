...
//nftw() - аналог ftw(), позволяющий отключить следование по символическим ссылкам
//во избежание повторной обработки файлов, имеющих символическую ссылку
...
int main(int argc, char * argv[])
{
    ...
    ret = dopath(argv[1], 0, show_file); //выполняет всю работу
