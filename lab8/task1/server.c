...
int main()
{
    // 0 - протокл TCP (Transmission Control Protocol), предоставляющий поток данных с предварительной установкой соединения и осуществляющий повторный запрос данных в случае потери данных и устраняет дублирование 
